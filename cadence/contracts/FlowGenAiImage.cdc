    ...
    access(all) fun resolveView(_ view: Type): AnyStruct? {
      switch view {
        case Type<MetadataViews.Display>():
          ...
          let thumbnailUrl: String = "https://".concat(self.ipfsImageCID).concat(".ipfs.w3s.link")
        ...
        case Type<MetadataViews.Editions>():
          ...
          let editionInfo: MetadataViews.Edition = MetadataViews.Edition(name: "FlowGenAiImage Edition", number: self.id, max: nil)
        ...
        case Type<MetadataViews.Media>():
          let imageUrl: String = "https://".concat(self.ipfsImageCID).concat(".ipfs.w3s.link")
      ...
      case Type<MetadataViews.NFTCollectionDisplay>():
        let media: MetadataViews.Media = MetadataViews.Media(
          file: MetadataViews.HTTPFile(
            url: "https://bafybeif4sttvb4lyfg6th2jg36zaexpxplt2mlzam235ccw7cevcky4yti.ipfs.w3s.link/flowgen-ai-image-collection.png"
          ),
          mediaType: "image/png"
        )
        return MetadataViews.NFTCollectionDisplay(
            name: "The FlowGen AI Image Collection",
          description: "This collection is for images generated by the FlowGen AI Image contract.",
